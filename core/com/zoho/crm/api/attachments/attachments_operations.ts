...
class AttachmentsOperations {
   ...
   * @throws SDKException
   */
  public async uploadUrlAttachments(
    recordId: bigint,
    module: string,
    paramInstance?: ParameterMap
  ): Promise<APIResponse<ActionHandler>> {
...
class GetAttachmentsParam {
  public static FIELDS: Param<string> = new Param<string>(
    "fields",
    "com.zoho.crm.api.Attachments.GetAttachmentsParam"
  );
...
class UploadUrlAttachmentsParam {
  public static ATTACHMENTURL: Param<string> = new Param<string>(
    "attachmentUrl",
    "com.zoho.crm.api.Attachments.UploadUrlAttachmentsParam"
  );
  public static TITLE: Param<string> = new Param<string>(
    "title",
    "com.zoho.crm.api.Attachments.UploadUrlAttachmentsParam"
  );
}
...
class DeleteAttachmentsParam {
  public static IDS: Param<string> = new Param<string>(
    "ids",
    "com.zoho.crm.api.Attachments.DeleteAttachmentsParam"
  );
}
