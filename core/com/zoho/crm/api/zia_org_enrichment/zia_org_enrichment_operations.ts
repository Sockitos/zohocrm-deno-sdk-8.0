...
class ZiaOrgEnrichmentOperations {
   ...
   * @throws SDKException
   */
  public async getZiaOrgEnrichments(
   ...
   * @throws SDKException
   */
  public async createZiaOrgEnrichment(
    request: BodyWrapper,
    paramInstance?: ParameterMap
   ...
   * @throws SDKException
   */
  public async getZiaOrgEnrichment(
    ziaOrgEnrichmentId: bigint
  ): Promise<APIResponse<ResponseHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    apiPath = apiPath.concat("/crm/v8/__zia_org_enrichment/");
...
class GetZiaOrgEnrichmentsParam {
  public static STATUS: Param<Choice<string>> = new Param<Choice<string>>(
    "status",
    "com.zoho.crm.api.ZiaOrgEnrichment.GetZiaOrgEnrichmentsParam"
  );
...
class CreateZiaOrgEnrichmentParam {
  public static MODULE: Param<string> = new Param<string>(
    "module",
    "com.zoho.crm.api.ZiaOrgEnrichment.CreateZiaOrgEnrichmentParam"
  );
