  ...
  public async getEntityScore(
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "fields",
          "com.zoho.crm.api.EntityScores.GetEntityScoreParam"
        ),
        this.fields
      )
      .catch((err) => {
  ...
  public async getEntityScores(
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "fields",
          "com.zoho.crm.api.EntityScores.GetEntityScoresParam"
        ),
        this.fields
      )
      .catch((err) => {
...
class GetEntityScoresHeader {
  public static IF_MODIFIED_SINCE: Header<Date> = new Header<Date>(
    "If-Modified-Since",
    "com.zoho.crm.api.EntityScores.GetEntityScoresHeader"
  );
}
