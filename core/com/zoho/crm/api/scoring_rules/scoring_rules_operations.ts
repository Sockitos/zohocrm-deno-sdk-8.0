...
import { LayoutRequestWrapper } from "./layout_request_wrapper.ts";
import { ResponseHandler } from "./response_handler.ts";
import { RoleRequestWrapper } from "./role_request_wrapper.ts";
...
class ScoringRulesOperations {
   ...
   * @throws SDKException
   */
  public async createScoringRules(
    request: BodyWrapper
   ...
   * @throws SDKException
   */
  public async updateScoringRules(
    request: BodyWrapper
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
   ...
   * @throws SDKException
   */
  public async deleteScoringRules(
    paramInstance?: ParameterMap
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
   ...
   * @throws SDKException
   */
  public async deleteScoringRule(
    id: bigint
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
   ...
   * @throws SDKException
   */
  public async activateScoringRule(
    id: bigint
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
   ...
   * @throws SDKException
   */
  public async deactivateScoringRule(
    id: bigint
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
   ...
   * @throws SDKException
   */
  public async scoringRuleExecutionUsingLayoutId(
    module: string,
    request: LayoutRequestWrapper
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
   ...
   * @throws SDKException
   */
  public async scoringRuleExecutionUsingRuleIds(
    module: string,
    request: RoleRequestWrapper
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    apiPath = apiPath.concat("/crm/v8/");
...
class GetScoringRulesParam {
  public static MODULE: Param<string> = new Param<string>(
    "module",
    "com.zoho.crm.api.ScoringRules.GetScoringRulesParam"
  );
  public static LAYOUT_ID: Param<bigint> = new Param<bigint>(
    "layout_id",
    "com.zoho.crm.api.ScoringRules.GetScoringRulesParam"
  );
  public static ACTIVE: Param<Choice<boolean>> = new Param<Choice<boolean>>(
    "active",
    "com.zoho.crm.api.ScoringRules.GetScoringRulesParam"
  );
  public static NAME: Param<bigint> = new Param<bigint>(
    "name",
    "com.zoho.crm.api.ScoringRules.GetScoringRulesParam"
  );
...
class DeleteScoringRulesParam {
  public static IDS: Param<string> = new Param<string>(
    "ids",
    "com.zoho.crm.api.ScoringRules.DeleteScoringRulesParam"
  );
}
...
class GetScoringRuleParam {
  public static LAYOUT_ID: Param<bigint> = new Param<bigint>(
    "layout_id",
    "com.zoho.crm.api.ScoringRules.GetScoringRuleParam"
  );
  public static ACTIVE: Param<Choice<boolean>> = new Param<Choice<boolean>>(
    "active",
    "com.zoho.crm.api.ScoringRules.GetScoringRuleParam"
