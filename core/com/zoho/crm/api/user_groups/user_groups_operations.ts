...
class UserGroupsOperations {
   ...
   * @throws SDKException
   */
  public async getAssociatedUsersCount(
    paramInstance?: ParameterMap
  ): Promise<APIResponse<ResponseHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    apiPath = apiPath.concat(
      "/crm/v8/settings/user_groups/actions/associated_users_count"
    );
    handlerInstance.setAPIPath(apiPath);
    handlerInstance.setHttpMethod(Constants.REQUEST_METHOD_GET);
    handlerInstance.setCategoryMethod(Constants.REQUEST_CATEGORY_ACTION);
   ...
   * @throws SDKException
   */
  public async getAssociateGroupsOfUser(
    user: bigint,
    paramInstance?: ParameterMap
  ): Promise<APIResponse<ResponseHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
...
class GetGroupsParam {
  public static INCLUDE: Param<string> = new Param<string>(
    "include",
    "com.zoho.crm.api.UserGroups.GetGroupsParam"
  );
  ...
  public static FILTERS: Param<Criteria> = new Param<Criteria>(
    "filters",
    "com.zoho.crm.api.UserGroups.GetGroupsParam"
  );
}
...
class GetSourcesParam {
  public static TYPE: Param<string> = new Param<string>(
    "type",
    "com.zoho.crm.api.UserGroups.GetSourcesParam"
  );
  public static USER_TYPE: Param<string> = new Param<string>(
    "user_type",
    "com.zoho.crm.api.UserGroups.GetSourcesParam"
  );
  public static PAGE: Param<string> = new Param<string>(
...
class GetAssociatedUsersCountParam {
  public static PAGE: Param<string> = new Param<string>(
    "page",
    "com.zoho.crm.api.UserGroups.GetAssociatedUsersCountParam"
  );
  public static PER_PAGE: Param<string> = new Param<string>(
    "per_page",
    "com.zoho.crm.api.UserGroups.GetAssociatedUsersCountParam"
...
class GetAssociateGroupsOfUserParam {
  public static INCLUDE: Param<string> = new Param<string>(
    "include",
    "com.zoho.crm.api.UserGroups.GetAssociateGroupsOfUserParam"
  );
  public static PAGE: Param<string> = new Param<string>(
    "page",
    "com.zoho.crm.api.UserGroups.GetAssociateGroupsOfUserParam"
...
class GetGroupedCountsParam {
  public static GROUP_BY: Param<string> = new Param<string>(
    "group_by",
    "com.zoho.crm.api.UserGroups.GetGroupedCountsParam"
  );
}
