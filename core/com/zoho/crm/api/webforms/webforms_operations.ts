...
class WebformsOperations {
  ...
  public async getWebForms(): Promise<APIResponse<ResponseHandler>> {
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.Webforms.GetWebFormsParam"
        ),
        this.module
      )
      .catch((err) => {
  ...
  public async createWebForms(
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.Webforms.CreateWebFormsParam"
        ),
        this.module
      )
      .catch((err) => {
  ...
  public async updateWebForms(
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.Webforms.UpdateWebFormsParam"
        ),
        this.module
      )
      .catch((err) => {
  ...
  public async getWebForm(
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.Webforms.GetWebFormParam"
        ),
        this.module
      )
      .catch((err) => {
  ...
  public async updateWebForm(
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.Webforms.UpdateWebFormParam"
        ),
        this.module
      )
      .catch((err) => {
  ...
  public async deleteWebForms(
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.Webforms.DeleteWebFormsParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async getWebformsPreview(
    formId: bigint
  ): Promise<APIResponse<ResponseHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.Webforms.GetWebformsPreviewParam"
        ),
        this.module
      )
      .catch((err) => {
