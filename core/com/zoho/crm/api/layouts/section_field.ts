import { Model } from "../../../../../../utils/util/model.ts";
import { AssociationDetails } from "../fields/association_details.ts";
import { AutoNumber } from "../fields/auto_number.ts";
import { ConvertMapping } from "../fields/convert_mapping.ts";
import { Crypt } from "../fields/crypt.ts";
import { Currency } from "../fields/currency.ts";
import { EmailParser } from "../fields/email_parser.ts";
import { External } from "../fields/external.ts";
import { Fields } from "../fields/fields.ts";
import { FileUpoladOption } from "../fields/file_upolad_option.ts";
import { Formula } from "../fields/formula.ts";
import { HipaaCompliance } from "../fields/hipaa_compliance.ts";
import { HistoryTracking } from "../fields/history_tracking.ts";
import { LayoutAssociation } from "../fields/layout_association.ts";
import { Lookup } from "../fields/lookup.ts";
import { MultiModuleLookup } from "../fields/multi_module_lookup.ts";
import { Multiselectlookup } from "../fields/multiselectlookup.ts";
import { OperationType } from "../fields/operation_type.ts";
import { PickListValue } from "../fields/pick_list_value.ts";
import { Private } from "../fields/private.ts";
import { Profile } from "../fields/profile.ts";
import { ReferFromField } from "../fields/refer_from_field.ts";
import { RollupSummary } from "../fields/rollup_summary.ts";
import { Subform } from "../fields/subform.ts";
import { Textarea } from "../fields/textarea.ts";
import { Tooltip } from "../fields/tooltip.ts";
import { Unique } from "../fields/unique.ts";
import { ViewType } from "../fields/view_type.ts";
import { Picklist } from "../global_picklists/picklist.ts";
import { MinifiedModule } from "../modules/minified_module.ts";
import { SharingProperties } from "../modules/sharing_properties.ts";
import { Delete1 } from "./delete1.ts";
import { StaticValues } from "./static_values.ts";

class SectionField extends Fields implements Model {
  protected required: boolean;
  protected validationRule: Map<string, any>;
  protected declare defaultValue: string;
  protected declare sequenceNumber: number;
  protected sectionId: number;
  protected declare blueprintSupported: boolean;
  protected declare jsonType: string;
  protected declare length: number;
  protected declare decimalPlace: number;
  protected declare multiModuleLookup: MultiModuleLookup;
  protected declare sharingProperties: SharingProperties;
  protected declare currency: Currency;
  protected declare fileUpoladOptionlist: Array<FileUpoladOption>;
  protected declare lookup: Lookup;
  protected declare subform: Subform;
  protected declare formula: Formula;
  protected declare multiselectlookup: Multiselectlookup;
  protected declare multiuserlookup: Multiselectlookup;
  protected declare pickListValues: Array<PickListValue>;
  protected declare allowedModules: Array<MinifiedModule>;
  protected declare hipaaComplianceEnabled: boolean;
  protected declare hipaaCompliance: HipaaCompliance;
  protected staticValues: Array<StaticValues>;
  protected declare staticField: boolean;
  protected declare layoutAssociations: Array<LayoutAssociation>;
  protected delete1: Delete1;
  protected declare associatedModule: MinifiedModule;
  protected declare dataType: string;
  protected declare operationType: OperationType;
  protected declare systemMandatory: boolean;
  protected declare webhook: boolean;
  protected declare virtualField: boolean;
  protected declare fieldReadOnly: boolean;
  protected declare customizableProperties: Array<string>;
  protected declare readOnly: boolean;
  protected declare customField: boolean;
  protected declare businesscardSupported: boolean;
  protected declare filterable: boolean;
  protected declare visible: boolean;
  protected declare availableInUserLayout: boolean;
  protected declare displayField: boolean;
  protected declare pickListValuesSortedLexically: boolean;
  protected declare sortable: boolean;
  protected declare separator: boolean;
  protected declare searchable: boolean;
  protected declare enableColourCode: boolean;
  protected declare massUpdate: boolean;
  protected declare createdSource: string;
  protected declare type: string;
  protected declare displayLabel: string;
  protected declare columnName: string;
  protected declare apiName: string;
  protected declare displayType: number;
  protected declare uiType: number;
  protected declare colourCodeEnabledBySystem: boolean;
  protected declare quickSequenceNumber: string;
  protected declare emailParser: EmailParser;
  protected declare rollupSummary: RollupSummary;
  protected declare referFromField: ReferFromField;
  protected declare createdTime: Date;
  protected declare modifiedTime: Date;
  protected declare showType: number;
  protected declare category: number;
  protected declare id: bigint;
  protected declare profiles: Array<Profile>;
  protected declare viewType: ViewType;
  protected declare unique: Unique;
  protected declare subModule: MinifiedModule;
  protected declare external: External;
  protected declare private1: Private;
  protected declare convertMapping: ConvertMapping;
  protected declare autonumber: AutoNumber;
  protected autoNumber71: AutoNumber;
  protected declare crypt: Crypt;
  protected declare tooltip: Tooltip;
  protected declare historyTrackingEnabled: boolean;
  protected declare historyTracking: HistoryTracking;
  protected declare associationDetails: AssociationDetails;
  protected declare additionalColumn: string;
  protected declare fieldLabel: string;
  protected declare globalPicklist: Picklist;
  protected declare updateExistingRecords: boolean;
  protected declare numberSeparator: boolean;
  protected declare textarea: Textarea;
   ...
   */
  public setFileUpoladOptionlist(
    fileUpoladOptionlist: Array<FileUpoladOption>
  ): void {
   ...
   */
  public setLayoutAssociations(
    layoutAssociations: Array<LayoutAssociation>
  ): void {
   ...
   */
  public setCustomizableProperties(
   ...
   */
  public setPickListValuesSortedLexically(
    pickListValuesSortedLexically: boolean
  ): void {
   ...
   */
  public setColourCodeEnabledBySystem(
    colourCodeEnabledBySystem: boolean
  ): void {
   ...
   * @returns An instance of AutoNumber
   */
  public getAutoNumber71(): AutoNumber {
    return this.autoNumber71;
  }

  /**
   * The method to set the value to autoNumber71
   * @param autoNumber71 An instance of AutoNumber
   */
  public setAutoNumber71(autoNumber71: AutoNumber): void {
   ...
   */
  public getHistoryTrackingEnabled(): boolean {
   ...
   */
  public setHistoryTrackingEnabled(historyTrackingEnabled: boolean): void {
...
export { SectionField as MasterModel, SectionField as SectionField };
