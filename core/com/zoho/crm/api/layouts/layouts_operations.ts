...
class LayoutsOperations {
   ...
   * @throws SDKException
   */
  public async updateCustomLayout(
    id: bigint,
    request: BodyWrapper,
    paramInstance?: ParameterMap
   ...
   * @throws SDKException
   */
  public async deleteCustomLayout(
    id: bigint,
    paramInstance?: ParameterMap
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
   ...
   * @throws SDKException
   */
  public async activateCustomLayout(
    id: bigint,
    request: BodyWrapper,
    paramInstance?: ParameterMap
  ): Promise<APIResponse<ActionHandler>> {
   ...
   * @throws SDKException
   */
  public async deactivateCustomLayout(
    id: bigint,
    paramInstance?: ParameterMap
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
...
class GetLayoutsParam {
  public static MODULE: Param<string> = new Param<string>(
    "module",
    "com.zoho.crm.api.Layouts.GetLayoutsParam"
  );
}
...
class GetLayoutParam {
  public static MODULE: Param<string> = new Param<string>(
    "module",
    "com.zoho.crm.api.Layouts.GetLayoutParam"
  );
}
...
class UpdateCustomLayoutParam {
  public static MODULE: Param<string> = new Param<string>(
    "module",
    "com.zoho.crm.api.Layouts.UpdateCustomLayoutParam"
  );
}
...
class DeleteCustomLayoutParam {
  public static MODULE: Param<string> = new Param<string>(
    "module",
    "com.zoho.crm.api.Layouts.DeleteCustomLayoutParam"
  );
...
class ActivateCustomLayoutParam {
  public static MODULE: Param<string> = new Param<string>(
    "module",
    "com.zoho.crm.api.Layouts.ActivateCustomLayoutParam"
  );
}
...
class DeactivateCustomLayoutParam {
  public static TRANSFER_TO: Param<string> = new Param<string>(
    "transfer_to",
    "com.zoho.crm.api.Layouts.DeactivateCustomLayoutParam"
  );
  public static MODULE: Param<string> = new Param<string>(
    "module",
    "com.zoho.crm.api.Layouts.DeactivateCustomLayoutParam"
