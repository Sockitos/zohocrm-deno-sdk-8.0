...
import { Folder } from "../inventory_templates/folder.ts";
import { InventoryTemplates } from "../inventory_templates/inventory_templates.ts";
import { ModuleMap } from "../inventory_templates/module_map.ts";
import { User } from "../inventory_templates/user.ts";
import { Template } from "../send_mail/template.ts";
import { Attachment } from "./attachment.ts";
import { LastVersionStatistics } from "./last_version_statistics.ts";
...
class EmailTemplate extends InventoryTemplates implements Model, Template {
  ...
  protected declare category: string;
  protected declare createdTime: Date;
  protected declare modifiedTime: Date;
  protected declare lastUsageTime: Date;
  protected declare folder: Folder;
  protected declare module: ModuleMap;
  protected declare createdBy: User;
  protected declare modifiedBy: User;
  protected declare name: string;
  protected declare id: bigint;
  protected declare editorMode: string;
  protected declare favorite: boolean;
  protected declare content: string;
  protected declare active: boolean;
  protected declare mailContent: string;
   ...
   */
  public setLastVersionStatistics(
    lastVersionStatistics: LastVersionStatistics
  ): void {
...
export { EmailTemplate as EmailTemplate, EmailTemplate as MasterModel };
