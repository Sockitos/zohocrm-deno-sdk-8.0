...
import { RelatedModules } from "./related_modules.ts";

class MassWrapper extends BodyWrapper implements Model {
  protected ids: Array<bigint>;
  protected declare owner: Owner;
  protected declare notify: boolean;
  protected declare relatedModules: Array<RelatedModules>;
...
export { MassWrapper as MassWrapper, MassWrapper as MasterModel };
