...
class EmailComposeOperations {
   ...
   * @throws SDKException
   */
  public async getEmailComposerDefaultSettings(
   ...
   * @throws SDKException
   */
  public async updateEmailComposerDefaultSettings(
    request: BodyWrapper
...
class GetEmailComposerDefaultSettingsParam {
  public static TYPE: Param<Choice<string>> = new Param<Choice<string>>(
    "type",
    "com.zoho.crm.api.EmailCompose.GetEmailComposerDefaultSettingsParam"
  );
}
