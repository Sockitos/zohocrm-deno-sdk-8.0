...
class ZiaPeopleEnrichmentOperations {
   ...
   * @throws SDKException
   */
  public async getZiaPeopleEnrichments(
   ...
   * @throws SDKException
   */
  public async createZiaPeopleEnrichment(
    request: BodyWrapper,
    paramInstance?: ParameterMap
   ...
   * @throws SDKException
   */
  public async getZiaPeopleEnrichment(
    ziaPeopleEnrichmentId: bigint
  ): Promise<APIResponse<ResponseHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    apiPath = apiPath.concat("/crm/v8/__zia_people_enrichment/");
...
class GetZiaPeopleEnrichmentsParam {
  public static STATUS: Param<Choice<string>> = new Param<Choice<string>>(
    "status",
    "com.zoho.crm.api.ZiaPeopleEnrichment.GetZiaPeopleEnrichmentsParam"
  );
  ...
  public static COUNT: Param<number> = new Param<number>(
    "count",
    "com.zoho.crm.api.ZiaPeopleEnrichment.GetZiaPeopleEnrichmentsParam"
  );
}
...
class CreateZiaPeopleEnrichmentParam {
  public static MODULE: Param<string> = new Param<string>(
    "module",
    "com.zoho.crm.api.ZiaPeopleEnrichment.CreateZiaPeopleEnrichmentParam"
  );
  public static RECORD_ID: Param<bigint> = new Param<bigint>(
    "record_id",
    "com.zoho.crm.api.ZiaPeopleEnrichment.CreateZiaPeopleEnrichmentParam"
  );
}
