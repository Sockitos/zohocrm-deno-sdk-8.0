...
class DuplicateCheckPreferenceOperations {
   ...
   * @throws SDKException
   */
  public async getDuplicateCheckPreference(): Promise<
  ...
  > {
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.DuplicateCheckPreference.GetDuplicateCheckPreferenceParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async createDuplicateCheckPreference(
    request: BodyWrapper
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.DuplicateCheckPreference.CreateDuplicateCheckPreferenceParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async updateDuplicateCheckPreference(
    request: BodyWrapper
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.DuplicateCheckPreference.UpdateDuplicateCheckPreferenceParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async deleteDuplicateCheckPreference(): Promise<
    APIResponse<ActionHandler>
  > {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    apiPath = apiPath.concat("/crm/v8/settings/duplicate_check_preference");
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.DuplicateCheckPreference.DeleteDuplicateCheckPreferenceParam"
        ),
        this.module
      )
      .catch((err) => {
