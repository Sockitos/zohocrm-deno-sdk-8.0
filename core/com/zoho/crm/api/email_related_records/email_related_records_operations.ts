...
class EmailRelatedRecordsOperations {
   ...
   * @throws SDKException
   */
  public async getEmailsRelatedRecords(
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "type",
          "com.zoho.crm.api.EmailRelatedRecords.GetEmailsRelatedRecordsParam"
        ),
        this.type
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async getEmailsRelatedRecord(
    messageId: string
  ): Promise<APIResponse<ResponseHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "type",
          "com.zoho.crm.api.EmailRelatedRecords.GetEmailsRelatedRecordParam"
        ),
        this.type
      )
      .catch((err) => {
...
class GetEmailsRelatedRecordsParam {
  public static FILTER: Param<Criteria> = new Param<Criteria>(
    "filter",
    "com.zoho.crm.api.EmailRelatedRecords.GetEmailsRelatedRecordsParam"
  );
  public static INDEX: Param<string> = new Param<string>(
    "index",
    "com.zoho.crm.api.EmailRelatedRecords.GetEmailsRelatedRecordsParam"
  );
}
