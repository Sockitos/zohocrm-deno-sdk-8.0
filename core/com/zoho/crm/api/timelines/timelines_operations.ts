...
class GetTimelinesParam {
  public static INCLUDE_INNER_DETAILS: Param<Choice<string>> = new Param<
    Choice<string>
  >("include_inner_details", "com.zoho.crm.api.Timelines.GetTimelinesParam");
  public static SORT_BY: Param<string> = new Param<string>(
    "sort_by",
    "com.zoho.crm.api.Timelines.GetTimelinesParam"
  );
  public static SORT_ORDER: Param<Choice<string>> = new Param<Choice<string>>(
    "sort_order",
    "com.zoho.crm.api.Timelines.GetTimelinesParam"
  );
  public static INCLUDE_TIMELINE_TYPE: Param<string> = new Param<string>(
    "include_timeline_type",
    "com.zoho.crm.api.Timelines.GetTimelinesParam"
  );
  public static INCLUDE: Param<Choice<string>> = new Param<Choice<string>>(
    "include",
    "com.zoho.crm.api.Timelines.GetTimelinesParam"
  );
