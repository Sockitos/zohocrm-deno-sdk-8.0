...
import { DeletedRecordsHandler } from "./deleted_records_handler.ts";
import { DownloadHandler } from "./download_handler.ts";
import { FileBodyWrapper } from "./file_body_wrapper.ts";
import { FileHandler } from "./file_handler.ts";
import { MassUpdateActionHandler } from "./mass_update_action_handler.ts";
import { MassUpdateBodyWrapper } from "./mass_update_body_wrapper.ts";
...
class RecordOperations {
  ...
  public async getDeletedRecords(
    paramInstance?: ParameterMap,
    headerInstance?: HeaderMap
  ): Promise<APIResponse<DeletedRecordsHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    apiPath = apiPath.concat("/crm/v8/");
    apiPath = apiPath.concat(this.moduleAPIName.toString());
  ...
  public async uploadPhoto(
    ...
    paramInstance?: ParameterMap
  ): Promise<APIResponse<FileHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    apiPath = apiPath.concat("/crm/v8/");
    apiPath = apiPath.concat(this.moduleAPIName.toString());
   ...
   * @throws SDKException
   */
  public async massUpdateRecords(
    request: MassUpdateBodyWrapper
  ): Promise<APIResponse<MassUpdateActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    apiPath = apiPath.concat("/crm/v8/");
    apiPath = apiPath.concat(this.moduleAPIName.toString());
   ...
   * @throws SDKException
   */
  public async getMassUpdateStatus(
    paramInstance?: ParameterMap
  ): Promise<APIResponse<MassUpdateResponseHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    apiPath = apiPath.concat("/crm/v8/");
    apiPath = apiPath.concat(this.moduleAPIName.toString());
   ...
   * @throws SDKException
   */
  public async assignTerritoriesToMultipleRecords(
    request: BodyWrapper
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
   ...
   * @throws SDKException
   */
  public async assignTerritoryToRecord(
    id: bigint,
    request: BodyWrapper
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
   ...
   * @throws SDKException
   */
  public async removeTerritoriesFromMultipleRecords(
    request: BodyWrapper
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
   ...
   * @throws SDKException
   */
  public async removeTerritoriesFromRecord(
    id: bigint,
    request: BodyWrapper
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
   ...
   * @throws SDKException
   */
  public async getRecordUsingExternalId(
   ...
   * @throws SDKException
   */
  public async updateRecordUsingExternalId(
    externalFieldValue: string,
    request: BodyWrapper,
    headerInstance?: HeaderMap
  ): Promise<APIResponse<ActionHandler>> {
   ...
   * @throws SDKException
   */
  public async deleteRecordUsingExternalId(
    externalFieldValue: string,
    paramInstance?: ParameterMap,
    headerInstance?: HeaderMap
  ): Promise<APIResponse<ActionHandler>> {
   ...
   * @throws SDKException
   */
  public async getFullDataForRichText(
    id: bigint,
    paramInstance?: ParameterMap
  ): Promise<APIResponse<ResponseHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
   ...
   * @throws SDKException
   */
  public async getRichTextRecords(
    paramInstance?: ParameterMap
  ): Promise<APIResponse<ResponseHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
...
class GetRecordParam {
  public static APPROVED: Param<string> = new Param<string>(
    "approved",
    "com.zoho.crm.api.Record.GetRecordParam"
  );
  public static CONVERTED: Param<string> = new Param<string>(
    "converted",
    "com.zoho.crm.api.Record.GetRecordParam"
  );
  public static CVID: Param<string> = new Param<string>(
    "cvid",
    "com.zoho.crm.api.Record.GetRecordParam"
  );
  public static UID: Param<string> = new Param<string>(
    "uid",
    "com.zoho.crm.api.Record.GetRecordParam"
  );
  ...
  public static STARTDATETIME: Param<Date> = new Param<Date>(
    "startDateTime",
    "com.zoho.crm.api.Record.GetRecordParam"
  );
  public static ENDDATETIME: Param<Date> = new Param<Date>(
    "endDateTime",
    "com.zoho.crm.api.Record.GetRecordParam"
  );
  public static TERRITORY_ID: Param<string> = new Param<string>(
    "territory_id",
    "com.zoho.crm.api.Record.GetRecordParam"
  );
  public static INCLUDE_CHILD: Param<string> = new Param<string>(
    "include_child",
    "com.zoho.crm.api.Record.GetRecordParam"
  );
  public static ON_DEMAND_PROPERTIES: Param<string> = new Param<string>(
...
class GetRecordHeader {
  public static IF_MODIFIED_SINCE: Header<Date> = new Header<Date>(
    "If-Modified-Since",
    "com.zoho.crm.api.Record.GetRecordHeader"
  );
...
class UpdateRecordHeader {
  public static X_EXTERNAL: Header<string> = new Header<string>(
    "X-EXTERNAL",
    "com.zoho.crm.api.Record.UpdateRecordHeader"
  );
}

class DeleteRecordParam {
  public static WF_TRIGGER: Param<boolean> = new Param<boolean>(
    "wf_trigger",
...
class DeleteRecordHeader {
  public static X_EXTERNAL: Header<string> = new Header<string>(
    "X-EXTERNAL",
    "com.zoho.crm.api.Record.DeleteRecordHeader"
  );
}
...
class GetRecordsHeader {
  public static IF_MODIFIED_SINCE: Header<Date> = new Header<Date>(
    "If-Modified-Since",
    "com.zoho.crm.api.Record.GetRecordsHeader"
  );
  public static X_EXTERNAL: Header<string> = new Header<string>(
    "X-EXTERNAL",
    "com.zoho.crm.api.Record.GetRecordsHeader"
...
class CreateRecordsHeader {
  public static X_EXTERNAL: Header<string> = new Header<string>(
    "X-EXTERNAL",
    "com.zoho.crm.api.Record.CreateRecordsHeader"
  );
}
...
class UpdateRecordsHeader {
  public static X_EXTERNAL: Header<string> = new Header<string>(
    "X-EXTERNAL",
    "com.zoho.crm.api.Record.UpdateRecordsHeader"
  );
}
...
class DeleteRecordsHeader {
  public static X_EXTERNAL: Header<string> = new Header<string>(
    "X-EXTERNAL",
    "com.zoho.crm.api.Record.DeleteRecordsHeader"
  );
}
...
class UpsertRecordsHeader {
  public static X_EXTERNAL: Header<string> = new Header<string>(
    "X-EXTERNAL",
    "com.zoho.crm.api.Record.UpsertRecordsHeader"
  );
}
...
class GetDeletedRecordsHeader {
  public static IF_MODIFIED_SINCE: Header<Date> = new Header<Date>(
    "If-Modified-Since",
    "com.zoho.crm.api.Record.GetDeletedRecordsHeader"
  );
}

class SearchRecordsParam {
  public static CRITERIA: Param<string> = new Param<string>(
    "criteria",
    "com.zoho.crm.api.Record.SearchRecordsParam"
  );
  public static EMAIL: Param<string> = new Param<string>(
    "email",
    "com.zoho.crm.api.Record.SearchRecordsParam"
  );
  public static PHONE: Param<string> = new Param<string>(
    "phone",
    "com.zoho.crm.api.Record.SearchRecordsParam"
  );
  public static WORD: Param<string> = new Param<string>(
    "word",
    "com.zoho.crm.api.Record.SearchRecordsParam"
  );
  public static CONVERTED: Param<string> = new Param<string>(
...
class SearchRecordsHeader {
  public static X_EXTERNAL: Header<string> = new Header<string>(
    "X-EXTERNAL",
    "com.zoho.crm.api.Record.SearchRecordsHeader"
  );
}

class UploadPhotoParam {
  public static RESTRICT_TRIGGERS: Param<string> = new Param<string>(
    "restrict_triggers",
    "com.zoho.crm.api.Record.UploadPhotoParam"
  );
}
...
class RecordCountParam {
  public static CVID: Param<string> = new Param<string>(
    "cvid",
    "com.zoho.crm.api.Record.RecordCountParam"
  );
  public static CRITERIA: Param<string> = new Param<string>(
    "criteria",
    "com.zoho.crm.api.Record.RecordCountParam"
...
class GetRecordUsingExternalIDParam {
  public static APPROVED: Param<string> = new Param<string>(
    "approved",
    "com.zoho.crm.api.Record.GetRecordUsingExternalIDParam"
  );
  public static CONVERTED: Param<string> = new Param<string>(
    "converted",
    "com.zoho.crm.api.Record.GetRecordUsingExternalIDParam"
...
class GetRecordUsingExternalIDHeader {
  public static IF_MODIFIED_SINCE: Header<Date> = new Header<Date>(
    "If-Modified-Since",
    "com.zoho.crm.api.Record.GetRecordUsingExternalIDHeader"
  );
  public static X_EXTERNAL: Header<string> = new Header<string>(
    "X-EXTERNAL",
    "com.zoho.crm.api.Record.GetRecordUsingExternalIDHeader"
...
class UpdateRecordUsingExternalIDHeader {
  public static X_EXTERNAL: Header<string> = new Header<string>(
    "X-EXTERNAL",
    "com.zoho.crm.api.Record.UpdateRecordUsingExternalIDHeader"
  );
}
...
class DeleteRecordUsingExternalIDParam {
  public static WF_TRIGGER: Param<boolean> = new Param<boolean>(
    "wf_trigger",
    "com.zoho.crm.api.Record.DeleteRecordUsingExternalIDParam"
  );
}
...
class DeleteRecordUsingExternalIDHeader {
  public static X_EXTERNAL: Header<string> = new Header<string>(
    "X-EXTERNAL",
    "com.zoho.crm.api.Record.DeleteRecordUsingExternalIDHeader"
  );
}
...
class GetFullDataForRichTextParam {
  public static FIELDS: Param<string> = new Param<string>(
    "fields",
    "com.zoho.crm.api.Record.GetFullDataForRichTextParam"
  );
}
...
class GetRichTextRecordsParam {
  public static IDS: Param<string> = new Param<string>(
    "ids",
    "com.zoho.crm.api.Record.GetRichTextRecordsParam"
  );
  public static FIELDS: Param<string> = new Param<string>(
    "fields",
    "com.zoho.crm.api.Record.GetRichTextRecordsParam"
