...
class GetNotificationsParam {
  public static PAGE: Param<number> = new Param<number>(
    "page",
    "com.zoho.crm.api.Notifications.GetNotificationsParam"
  );
  public static PER_PAGE: Param<number> = new Param<number>(
    "per_page",
    "com.zoho.crm.api.Notifications.GetNotificationsParam"
  );
  public static CHANNEL_ID: Param<bigint> = new Param<bigint>(
    "channel_id",
    "com.zoho.crm.api.Notifications.GetNotificationsParam"
  );
...
class DeleteNotificationParam {
  public static CHANNEL_IDS: Param<bigint> = new Param<bigint>(
    "channel_ids",
    "com.zoho.crm.api.Notifications.DeleteNotificationParam"
  );
}
