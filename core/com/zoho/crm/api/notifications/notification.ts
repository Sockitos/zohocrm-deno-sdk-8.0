...
import { NotificationCondition } from "./notification_condition.ts";

class Notification extends Event implements Model {
  protected declare channelId: string;
  ...
  protected declare resourceName: string;
  protected declare channelExpiry: Date;
  protected declare resourceId: bigint;
  protected declare resourceUri: string;
  protected declare notificationCondition: Array<NotificationCondition>;
   ...
   */
  public setReturnAffectedFieldValues(
   ...
   */
  public setNotificationCondition(
    notificationCondition: Array<NotificationCondition>
  ): void {
...
export { Notification as MasterModel, Notification as Notification };
