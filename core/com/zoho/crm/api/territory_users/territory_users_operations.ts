...
class TerritoryUsersOperations {
   ...
   * @throws SDKException
   */
  public async getTerritoryUsers(
    territory: bigint
   ...
   * @throws SDKException
   */
  public async updateTerritoryUsers(
    territory: bigint,
    request: BodyWrapper
   ...
   * @throws SDKException
   */
  public async deassociateTerritoryUsers(
    territory: bigint,
   ...
   * @throws SDKException
   */
  public async updateTerritoryUser(
    user: bigint,
    territory: bigint
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
   ...
   * @throws SDKException
   */
  public async deassociateTerritoryUser(
    user: bigint,
    territory: bigint
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
...
class DeassociateTerritoryUsersParam {
  public static IDS: Param<string> = new Param<string>(
    "ids",
    "com.zoho.crm.api.TerritoryUsers.DeassociateTerritoryUsersParam"
  );
}
