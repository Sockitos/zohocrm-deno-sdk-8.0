...
import { FiltersBody } from "./filters_body.ts";
import { ResponseHandler } from "./response_handler.ts";
import { SummaryResponseHandler } from "./summary_response_handler.ts";
...
class SharingRulesOperations {
  ...
  public async getSharingRules(
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.SharingRules.GetSharingRulesParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async createSharingRules(
    request: BodyWrapper
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.SharingRules.CreateSharingRulesParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async updateSharingRules(
    request: BodyWrapper
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.SharingRules.UpdateSharingRulesParam"
        ),
        this.module
      )
      .catch((err) => {
  ...
  public async getSharingRule(
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.SharingRules.GetSharingRuleParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async updateSharingRule(
    id: bigint,
    request: BodyWrapper
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.SharingRules.UpdateSharingRuleParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async deleteSharingRule(
    id: bigint
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.SharingRules.DeleteSharingRuleParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async searchSharingRules(
    request: FiltersBody,
    paramInstance?: ParameterMap
  ): Promise<APIResponse<ResponseHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.SharingRules.SearchSharingRulesParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async deactivateSharingRule(
    id: bigint
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.SharingRules.DeactivateSharingRuleParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async activateSharingRule(
    id: bigint
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.SharingRules.ActivateSharingRuleParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async getSharingRuleSummary(): Promise<
    APIResponse<SummaryResponseHandler>
  > {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    apiPath = apiPath.concat(
      "/crm/v8/settings/data_sharing/rules/actions/summary"
    );
    handlerInstance.setAPIPath(apiPath);
    handlerInstance.setHttpMethod(Constants.REQUEST_METHOD_GET);
    handlerInstance.setCategoryMethod(Constants.REQUEST_CATEGORY_READ);
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.SharingRules.GetSharingRuleSummaryParam"
        ),
        this.module
      )
      .catch((err) => {
    ...
    let SummaryResponseHandler = import.meta.resolve(
      "./summary_response_handler.ts"
    );
    return handlerInstance.apiCall<SummaryResponseHandler>(
   ...
   * @throws SDKException
   */
  public async searchSharingRulesSummary(
    request: FiltersBody
  ): Promise<APIResponse<SummaryResponseHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    apiPath = apiPath.concat(
      "/crm/v8/settings/data_sharing/rules/actions/summary"
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.SharingRules.SearchSharingRulesSummaryParam"
        ),
        this.module
      )
      .catch((err) => {
  ...
  public async rerunSharingRules(): Promise<APIResponse<ActionHandler>> {
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.SharingRules.RerunSharingRulesParam"
        ),
        this.module
      )
      .catch((err) => {
