...
import { QueryDetails } from "../fields/query_details.ts";
import { ShowFields } from "../fields/show_fields.ts";
import { MinifiedModule } from "./minified_module.ts";

class ModuleFieldLookup extends Lookup implements Model {
  protected declare queryDetails: QueryDetails;
  protected declare module: MinifiedModule;
  protected declare displayLabel: string;
  protected declare apiName: string;
  protected declare id: bigint;
  protected declare revalidateFilterDuringEdit: boolean;
  protected declare showFields: Array<ShowFields>;
   ...
   */
  public setRevalidateFilterDuringEdit(
    revalidateFilterDuringEdit: boolean
  ): void {
