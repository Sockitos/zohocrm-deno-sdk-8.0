import {CustomViews} from "../custom_views/custom_views.ts"
import {LayoutAssociation} from "../fields/layout_association.ts"
import {MinifiedField} from "../fields/minified_field.ts"
import {Argument} from "./argument.ts"
import {LookupFieldProperties} from "./lookup_field_properties.ts"
import {MinifiedModule} from "./minified_module.ts"
import {ModuleFields} from "./module_fields.ts"
import {RelatedListProperties} from "./related_list_properties.ts"
import {StaticSubformProperties} from "./static_subform_properties.ts"
import {Territory} from "./territory.ts"
import {MinifiedProfile} from "../profiles/minified_profile.ts"
import {RelatedList} from "../related_lists/related_list.ts"
import {MinifiedUser} from "../users/minified_user.ts"
...
class Modules implements Model{
	 ...
	 * @returns An Object representing the displayField
	 */
	public getDisplayField(): any	{
	 ...
	 * @param displayField An Object representing the displayField
	 */
	public setDisplayField(displayField: any): void	{
