...
class RecordLockingConfigurationOperations {
   ...
   * @throws SDKException
   */
  public async getRecordLockingConfigurations(
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.RecordLockingConfiguration.GetRecordLockingConfigurationsParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async addRecordLockingConfiguration(
    request: BodyWrapper
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.RecordLockingConfiguration.AddRecordLockingConfigurationParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async updateRecordLockingConfigurations(
    request: BodyWrapper
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.RecordLockingConfiguration.UpdateRecordLockingConfigurationsParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async updateRecordLockingConfiguration(
    recordLockingConfigId: bigint,
    request: BodyWrapper
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.RecordLockingConfiguration.UpdateRecordLockingConfigurationParam"
        ),
        this.module
      )
      .catch((err) => {
   ...
   * @throws SDKException
   */
  public async deleteRecordLockingConfiguration(
    recordLockingConfigId: bigint
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    ...
    await handlerInstance
      .addParam(
        new Param<string>(
          "module",
          "com.zoho.crm.api.RecordLockingConfiguration.DeleteRecordLockingConfigurationParam"
        ),
        this.module
      )
      .catch((err) => {
...
class GetRecordLockingConfigurationsParam {
  public static FEATURE_TYPE: Param<string> = new Param<string>(
    "feature_type",
    "com.zoho.crm.api.RecordLockingConfiguration.GetRecordLockingConfigurationsParam"
  );
}
