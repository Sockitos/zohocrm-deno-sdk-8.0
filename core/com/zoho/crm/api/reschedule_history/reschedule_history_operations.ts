...
class RescheduleHistoryOperations {
   ...
   * @throws SDKException
   */
  public async addAppointmentsRescheduledHistory(
    request: BodyWrapper
   ...
   * @throws SDKException
   */
  public async updateAppointmentsRescheduledHistory(
    request: BodyWrapper
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
   ...
   * @throws SDKException
   */
  public async getAppointmentsRescheduledHistory(
   ...
   * @throws SDKException
   */
  public async updateAppointmentRescheduledHistory(
    id: bigint,
    request: BodyWrapper
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
   ...
   * @throws SDKException
   */
  public async getAppointmentRescheduledHistory(
    id: bigint,
    paramInstance?: ParameterMap
  ): Promise<APIResponse<ResponseHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
   ...
   * @throws SDKException
   */
  public async deleteAppointmentsRescheduledHistory(
    id: bigint
  ): Promise<APIResponse<ActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
...
class GetAppointmentsRescheduledHistoryParam {
  public static FIELDS: Param<string> = new Param<string>(
    "fields",
    "com.zoho.crm.api.RescheduleHistory.GetAppointmentsRescheduledHistoryParam"
  );
...
class GetAppointmentRescheduledHistoryParam {
  public static FIELDS: Param<string> = new Param<string>(
    "fields",
    "com.zoho.crm.api.RescheduleHistory.GetAppointmentRescheduledHistoryParam"
  );
}
