...
import { ExistingTagRequestWrapper } from "./existing_tag_request_wrapper.ts";
import { MergeWrapper } from "./merge_wrapper.ts";
import { NewTagRequestWrapper } from "./new_tag_request_wrapper.ts";
import { RecordActionHandler } from "./record_action_handler.ts";
...
class TagsOperations {
  ...
  public async addTags(
    ...
    paramInstance?: ParameterMap
  ): Promise<APIResponse<RecordActionHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
    let apiPath: string = "";
    ...
    handlerInstance.setMandatoryChecker(true);
    handlerInstance.setParam(paramInstance);
    let RecordActionHandler = import.meta.resolve("./record_action_handler.ts");
    return handlerInstance.apiCall<RecordActionHandler>(
      RecordActionHandler,
      "application/json"
    );
  }
   ...
   * @throws SDKException
   */
  public async addTagsToMultipleRecords(
    moduleAPIName: string,
    request: NewTagRequestWrapper,
    paramInstance?: ParameterMap
  ): Promise<APIResponse<RecordActionHandler>> {
   ...
   * @throws SDKException
   */
  public async removeTagsFromMultipleRecords(
    moduleAPIName: string,
    request: ExistingTagRequestWrapper,
    paramInstance?: ParameterMap
  ): Promise<APIResponse<RecordActionHandler>> {
   ...
   * @throws SDKException
   */
  public async getRecordCountForTag(
    id: bigint,
    paramInstance?: ParameterMap
  ): Promise<APIResponse<ResponseHandler>> {
    let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
...
class GetTagsParam {
  public static MODULE: Param<string> = new Param<string>(
    "module",
    "com.zoho.crm.api.Tags.GetTagsParam"
  );
  public static MY_TAGS: Param<string> = new Param<string>(
    "my_tags",
    "com.zoho.crm.api.Tags.GetTagsParam"
  );
...
class CreateTagsParam {
  public static MODULE: Param<string> = new Param<string>(
    "module",
    "com.zoho.crm.api.Tags.CreateTagsParam"
  );
  public static COLOR_CODE: Param<string> = new Param<string>(
    "color_code",
    "com.zoho.crm.api.Tags.CreateTagsParam"
  );
}
...
class UpdateTagsParam {
  public static MODULE: Param<string> = new Param<string>(
    "module",
    "com.zoho.crm.api.Tags.UpdateTagsParam"
  );
}
...
class UpdateTagParam {
  public static MODULE: Param<string> = new Param<string>(
    "module",
    "com.zoho.crm.api.Tags.UpdateTagParam"
  );
}

class AddTagsParam {
  public static OVER_WRITE: Param<string> = new Param<string>(
    "over_write",
    "com.zoho.crm.api.Tags.AddTagsParam"
  );
}
...
class AddTagsToMultipleRecordsParam {
  public static OVER_WRITE: Param<string> = new Param<string>(
    "over_write",
    "com.zoho.crm.api.Tags.AddTagsToMultipleRecordsParam"
  );
}
...
class RemoveTagsFromMultipleRecordsParam {
  public static IDS: Param<string> = new Param<string>(
    "ids",
    "com.zoho.crm.api.Tags.RemoveTagsFromMultipleRecordsParam"
  );
}
...
class GetRecordCountForTagParam {
  public static MODULE: Param<string> = new Param<string>(
    "module",
    "com.zoho.crm.api.Tags.GetRecordCountForTagParam"
  );
}
