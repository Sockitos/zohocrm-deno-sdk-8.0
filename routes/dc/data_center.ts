...
class DataCenter {
  ...
  public static async get(config: string) {
    const USDataCenter = (await import("./us_data_center.ts")).USDataCenter;
    const JPDataCenter = (await import("./jp_data_center.ts")).JPDataCenter;
    const INDataCenter = (await import("./in_data_center.ts")).INDataCenter;
    const EUDataCenter = (await import("./eu_data_center.ts")).EUDataCenter;
    const CNDataCenter = (await import("./cn_data_center.ts")).CNDataCenter;
    const AUDataCenter = (await import("./au_data_center.ts")).AUDataCenter;
    const CADataCenter = (await import("./ca_data_center.ts")).CADataCenter;
    const SADataCenter = (await import("./sa_data_center.ts")).SADataCenter;
    const Constants = (await import("../../utils/util/constants.ts")).Constants;
...
export { DataCenter as DataCenter, DataCenter as MasterModel };
