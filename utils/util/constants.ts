export class Constants {
  ...
  public static REVOKE_TOKEN_ERROR =
    "Exception while revoke the refresh token.";
  ...
  public static GET_TOKEN_DB_ERROR1 =
    "Exception in DBStore : Given user authentication details not found.";
  public static GENERATE_TOKEN_ID_ERROR = "Exception in generateId() - DBStore";
  public static GET_TOKEN_FILE_ERROR1 =
    "Exception in FileStore : Given user authentication details not found.";
  public static ACCESS_TOKEN_USING_REFRESH_TOKEN_MESSAGE =
    "Access token can be generated by refresh token";
  public static ACCESS_TOKEN_USING_GRANT_TOKEN_MESSAGE =
    "Access token can be generated by grant token.";
  public static GET_TOKEN_BY_USER_NAME_ERROR =
    "Exception in getToken() - OAuthToken : Given user_name token details not found, Please give required item";
  ...
  public static DELETE_TOKENS_DB_ERROR =
    "Exception in deleteTokens - DBStore : ";
  ...
  public static DELETE_TOKEN_FILE_ERROR =
    "Exception in deleteToken - FileStore : ";
  public static DELETE_TOKENS_FILE_ERROR =
    "Exception in deleteTokens - FileStore : ";
  ...
  public static MANDATORY_KEY_ERROR =
    "Value missing or null for mandatory key(s) :";
  ...
  public static HEADER_PARAM_VALIDATION_ERROR =
  ...
  public static EXCEPTION_IS_KEY_MODIFIED =
    "Exception in calling isKeyModified";
  public static EXCEPTION_SET_KEY_MODIFIED =
    "Exception in calling setKeyModified";
  ...
  public static RECURRING_ACTIVITY_NAMESPACE =
  ...
  public static INVENTORY_MODULES = [
    "invoices",
    "sales_orders",
    "purchase_orders",
    "quotes",
  ...
  public static DELETE_FIELD_FILE_ERROR =
    "Exception in deleting Current User Fields file";
  public static DELETE_FIELD_FILES_ERROR =
    "Exception in deleting all Fields files";
  public static DELETE_MODULE_FROM_FIELDFILE_ERROR =
  ...
  public static USER_NOT_FOUND_ERROR_MESSAGE =
  ...
  public static RESOURCE_PATH_ERROR_MESSAGE =
    "Resource Path MUST NOT be null/empty.";
  ...
  public static REFRESH_TOKEN_MESSAGE =
    "Access Token has expired. Hence refreshing.";
  ...
  public static REFRESH_SINGLE_MODULE_FIELDS_ERROR =
    "Exception in refreshing fields of module : ";
  public static REFRESH_ALL_MODULE_FIELDS_ERROR =
    "Exception in refreshing fields of all modules : ";
  public static SKIP_MANDATORY = "skip-mandatory";
  public static PRIMARY_KEY_ERROR =
    "Value missing or null for required key(s) : ";
  public static PICKLIST = "picklist";
  public static AUTO_REFRESH_FIELDS_ERROR_MESSAGE =
  ...
  public static UNSUPPORTED_IN_API_MESSAGE =
    " Operation is not supported by API";
  ...
  public static REGULAR_EXPRESSION =
    /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/;
  public static SDK_NAME = "typescript-8.0";
  public static RESOURCE_PATH_INVALID_ERROR_MESSAGE =
  ...
  public static USER_MAIL_NULL_ERROR_MESSAGE =
    "User Mail MUST NOT be null. Use userMail setter to set value.";
  public static GET_TOKEN_BY_ID_FILE_ERROR =
  ...
  public static CLIENT_SECRET_NULL_ERROR_MESSAGE =
    "ClientSecret MUST NOT be null";
  public static OAUTH_MANDATORY_KEYS = [
    "grantToken",
    "refreshToken",
    "id",
    "accessToken",
  ];
  public static OAUTH_MANDATORY_KEYS1 = [
    Constants.CLIENT_ID,
    Constants.CLIENT_SECRET,
  ];
  public static INVALID_TOKEN_ERROR = "INVALID TOKEN ERROR";
  public static NO_ACCESS_TOKEN_ERROR =
    "ACCESS TOKEN IS NOT PRESENT IN RESPONSE";
  public static GET_TOKEN_BY_ID_DB_ERROR =
    "Exception in getTokenById - DBStore : Given ID is invalid";
  public static USER_SIGNATURE_ERROR_MESSAGE =
    "UserSignature MUST NOT be null.";
  ...
  public static PHOTO_SUPPORTED_MODULES = [
    "leads",
    "contacts",
    "accounts",
    "products",
  ...
  public static UPLOAD_PHOTO_UNSUPPORTED_ERROR =
    "UPLOAD PHOTO UNSUPPORTED MODULE";
  public static UPLOAD_PHOTO_UNSUPPORTED_MESSAGE =
  ...
  public static LINEITEM_PRODUCT =
  ...
  public static INVENTORY_MODULES_ITEMS = [
    "invoiced_items",
    "quoted_items",
    "purchase_items",
    "ordered_items",
  ...
  public static OAUTH_MANDATORY_KEYS2 = [
    Constants.GRANT_TOKEN,
    Constants.REFRESH_TOKEN,
  ];
  public static IMAGEUPLOAD_NAMESPACE =
    "core/com/zoho/crm/api/record/image_upload";
  public static MULTI_MODULE_LOOKUP = "multi_module_lookup";
  public static IMAGE_UPLOAD_NAMESPACE =
    "core/com/zoho/crm/api/record/image_upload";
  public static AU_DATACENTER = [
  ...
  public static SA_DATACENTER = [
    "https://www.zohoapis.sa",
    "https://sandbox.zohoapis.sa",
    "https://developer.zohoapis.sa",
    "https://accounts.zoho.sa/oauth/v2/token",
    "sa",
  ];
  public static ENVIRONMENT_ERROR =
    "The given DataCenter config not valid. Please check the domain URL";
  ...
  public static ENVIRONMENT_ERROR_RESPONSE =
    "Exception in set the api environment.";
  ...
  public static TIME_RANGE_NAMESPACE =
    "core/com/zoho/crm/api/record/time_range";
